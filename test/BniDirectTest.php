...
class BniDirectTest extends TestCase
{
    private function init()
    {
        ...
        return new Bni(
            ...
            $bniDirectKey = $credentials->api_services->bniDirectKey
        );
    }
    ...
    public function test_bni_pops_product_allocation()
    {
        ...
        $response = $bniDirect->bniPopsProductAllocation(
            ...
            $debitOrCreditNoteNo= '123231',
            $productInformationDetail= array(
                (object) array('materialCode' => 'A040900001', 'trip' => '1123123', 'quantity' => '100', 'deliveryDate' => '20231112', 'transportir' => '')
            )
        );
        $this->assertEquals($response->requestStatus, '0');
    }
    ...
    //         $notificationFlag= 'N',
    //         $beneficiaryEmail= '',
    //         $transactionInstructionDate= "20240206",
    //         $amountCurrency= "IDR",
    //         $amount= "2000000"
    ...
    //         $remitterReferenceNo= 'UYY202309260002',
    //         $finalizePaymentFlag= 'Y',
